...
class Car{
    ...
    public function get_value_car($value){
        $this->value = $value;
        return $this->value ;
    }

    
   public function type_car_name($name){
        
        echo "my car is". $this->name;
    }
}
$bmw =new  Car('bmw ', '2000');
$bmw -> type_car_name('bmw');

?>
<div id="main_container">
    <!--Begin \mahan\template-parts\category cat4.php-->
    <!--Begin \mahan\template-parts\category cat4.php-->
    <header>
