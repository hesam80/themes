...
<!-- Mirrored from cooper.mustachethemes.com/1/home2.html page-363.php  -->
<head>
                    ...
                    <div class="content_menu wrap">
                        ...
                        <nav class="navbar span3">
                            ...
                            <div class="nav-collapse collapse">
                                ...
                                <li class="menu_item"><a href="<?php bloginfo('url'); ?>/?p=52">تحصیلات </a></li>
                                <li class="menu_item"><a href="<?php bloginfo('url'); ?>/?p=52">پورتفولیو </a></li>
                                <li class="menu_item"><a href="<?php bloginfo('url'); ?>/?p=52">تجربه کاری </a></li>
                                        ...
                                        <!-- <div class="tab-pane active" id="popular"> 
                                            <!--<ul>
                                                <li class="console first">
                                                    ...
                                                    <h6><i class="icon-calendar"></i><?php the_Author();  ?></h6>
                                                </li>
                                                <li class="console">
